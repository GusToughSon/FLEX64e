...
@interface FLEXSettingsController : UITableViewController <UISearchResultsUpdating>
...
@implementation FLEXSettingsController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"FLEX 64e Settings";
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    FLEXSettingsController *vc = [[FLEXSettingsController alloc] initWithStyle:UITableViewStyleGrouped];
